...
CONFIG = {
    ...
    'default_unit_size': 1,            # Number of units per sub-strategy (Issue 42)
    ...
    'portfolio_start_time': '08:33:00', # First sub-strategy start time
    'portfolio_end_time': '10:33:00',   # Last sub-strategy start time
